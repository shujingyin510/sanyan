...
**跨语言稳定性**：Qwen2.5-0.5B 中文 (n=1000): FP=**0.6%**, avg min_UR=**0.714** — vs 英文 FP=0.4%, avg=0.717。UR 阈值在规模上语言无关。

**阈值选择**（实测 ROC, 1214 样本）：Youden's J 最优 = 0.32。我们选 **0.30**——TPR 拐点（0.847→0.993 跳跃），相对最优更保守，最小化 FPR。
