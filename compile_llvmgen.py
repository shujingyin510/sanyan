...
HELPERS = [
    ...
    make_fn('查找', ['s', 'sub'], [
        ...
        ['set', 'sublen', ['取长', 'sub']],
        ['set', 'i', 0],
        ['loop', ['小于', 'i', ['加', ['减', 'slen', 'sublen'], 1]],
            ['do',
                ['if', ['等于', ['子串', 's', 'i', 'sublen'], 'sub'],
                    ['return', 'i']],
                ['set', 'i', ['加', 'i', 1]]]],
        ['return', -1],
    ]),
    ...
    make_fn('循环出栈', [], [
        ...
        ['if', ['大于', 'llen', 0],
            ['set', '_loop_stack', ['切片', '_loop_stack', 0, ['减', 'llen', 1]]]],
        ['return', 0],
    ]),
