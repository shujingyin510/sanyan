...
print(f"整体: {sum(1 for r in results if r['file_ok'] and (r['expected_func'] is None or r['func_ok']))/len(results):.0%}")

os.makedirs("benchmarks", exist_ok=True)
with open("benchmarks/param_extraction.json", "w", encoding="utf-8") as f:
    json.dump({"accuracy": {"file": file_accuracy, "func": func_accuracy}, "results": results}, f, indent=2, ensure_ascii=False)
