...
def _register_aliases():
    ...
    aliases = [
        ...
        ('连接', 'concat'), ('取长', 'length'), ('子串', 'substring'),
        ('查找', 'find'), ('分割', 'split'), ('包含', 'contains'),
        ('字典键列表', 'dict_keys'), ('含键', 'dict_contains'), ('置键', 'set_key'),
        ('取键', 'get_key'), ('删除键', 'delete_key'), ('列表合', 'list_concat'),
        ('取', 'get'), ('不', 'not'), ('读文件', 'read_file'), ('写文件', 'write_file'),
