...
> **状态（2026-09-10）**：**自更新闭环线冻结**。S0/S2/S4 已落地保留；S1/S3/S5/S6 暂停，不再扩功能。死因考古见知识库 `Agent-自更新死因考古`；解冻条件=换强模型，或约束系统收尾后重评。本 README 仅作现状说明与维护参考，**不是待办路线图**。
...
设 模型URL = "https://api.deepseek.com/chat/completions"
