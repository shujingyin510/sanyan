...
class TestValues(unittest.TestCase):
    ...
    def test_exception_classes(self):
        ...
        for c in [SanyanSyntaxError, SanyanTypeError, SanyanValueError,
                   SanyanRuntimeError, SanyanNameError, SanyanKeyError,
                   SanyanAttributeError, SanyanIOError]:
            self.assertIn("test", str(c("test")))


class TestTernaryCore(unittest.TestCase):
    def test_trit_math(self):
        from ternary_core import TritValue, BT, TT, FT
