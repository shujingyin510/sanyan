...
register('add', MathOps.arithmetic, 'add')
register('sub', MathOps.arithmetic, 'sub')
register('mul', MathOps.arithmetic, 'mul')
register('div', MathOps.arithmetic, 'div')
register('mod', MathOps.arithmetic, 'mod')
register('pow', MathOps.arithmetic, 'pow')
register('digit', MathOps.arithmetic, 'digit')
register('eq', MathOps.comparison, 'eq')
register('gt', MathOps.comparison, 'gt')
register('lt', MathOps.comparison, 'lt')
register('ne', MathOps.comparison, 'ne')
register('gte', MathOps.comparison, 'gte')
register('lte', MathOps.comparison, 'lte')
register('ngt', MathOps.comparison, 'ngt')
register('nlt', MathOps.comparison, 'nlt')
register('same', MathOps.equals_op)
register('abs', MathOps.math_abs)
register('max', MathOps.math_max)
register('min', MathOps.math_min)
...
register('log', MathOps.math_log)
register('log10', MathOps.math_log10)
register('floor', MathOps.math_floor)
register('ceil', MathOps.math_ceil)
register('round', MathOps.math_round)
register('math_pow', MathOps.math_pow)
register('ternary', MathOps.ternary_parse)
